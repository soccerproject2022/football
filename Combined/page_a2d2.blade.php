  ...
  <body>
    ...
    @extends('frontend.top_menu')
      ...
      <div id="u42" class="ax_default" data-label="Date" data-left="896" data-top="98" data-width="320" data-height="30">
        ...
        <div id="u44" class="ax_default label" data-label="After_tomorrow">
          <div id="u44_div" class=""></div>
          <div id="u44_text" class="text " onclick="window.location='/footballui/public/page_a2d3';">
            <p><span>後日</span></p>
          </div>
        </div>

        <!-- Tomorrow (Rectangle) -->
        <div id="u45" class="ax_default label" data-label="Tomorrow" style="background-color:#5D5D5D">
          <div id="u45_div" class=""></div>
          <div id="u45_text" class="text " style="color:white">
            <p><span>明日</span></p>
          </div>
        </div>
