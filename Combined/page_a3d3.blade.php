...
<html>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u74" class="ax_default" data-label="Logo_Group1" data-left="372" data-top="583" data-width="651" data-height="224">
        ...
        <div id="u75" class="ax_default image" data-label="g_logo">
          <img id="u75_img" class="img " src="{{ asset($datum->g_img) }}"/>
        ...
        <div id="u76" class="ax_default image" data-label="h_logo">
          <img id="u76_img" class="img " src="{{ asset($datum->h_img) }}"/>
        ...
        <div id="u79" class="ax_default box_2" data-label="Date_Time">
          ...
          <div id="u79_text" class="text ">
            <p><span>{{ Carbon\Carbon::parse($datum->date)->diffForHumans() }}開波</span></p>
          </div>
        </div>
      ...
      {{ $b3s->links('vendor.pagination.semantic-ui') }}
      ...
      <div id="u87" class="ax_default" data-label="Date" data-left="896" data-top="98" data-width="320" data-height="28">
        ...
        <div id="u88" class="ax_default label" data-label="After_tomorrow" style="background-color:#5D5D5D">
          <div id="u88_div" class=""></div>
          <div id="u88_text" class="text " style="color:white">
            <p><span>後日</span></p>
          </div>
        </div>

        <!-- Tomorrow (Rectangle) -->
        <div id="u89" class="ax_default label" data-label="Tomorrow" onclick="window.location='/footballui/public/page_a3d2';">
        ...
        <!-- Today (Rectangle) -->
        <div id="u90" class="ax_default label" data-label="Today" onclick="window.location='/footballui/public/page_a3';">
    ...
    <div id="heat" class="heat">
    <div class="card-header card-header-border-bottom">
            <h2>賽程表</h2>
        </div>
        <div class="card-body">
            <p class="mb-5"></a></p>
            <table class="table table-hover " cellspacing=0 style="text-align:center; margin-top:50px; margin-left:50px; background-color:Bisque; border-color:yellow; border-width:2px;">
                <thead>
                    <tr>
                        <th scope="col"></th>
                        <th scope="col" width="80">主勝</th>
                        <th scope="col" width="80">和波</th>
                        <th scope="col" width="80">客勝</th>
                ...
                <tbody>
                    ...
                    @foreach($b3s as $datum)
                    <tr>
                        <td>{{ $datum->host }} VS {{ $datum->guest }}</td>
                        <td id=tb>{{ $datum->h_gp }}</td>
                        <td id=tb>{{ $datum->d_gp }}</td>
                        <td id=tb>{{ $datum->g_gp }}</td>
