  ...
  <body>
   <div id="base" class="">
      ...
      <div id="u75" class="ax_default" data-label="Date" data-left="896" data-top="98" data-width="320" data-height="28">
        ...
        <div id="u76" class="ax_default label" data-label="After_tomorrow" style="background-color:#5D5D5D">
          <div id="u76_div" class=""></div>
          <div id="u76_text" class="text " style="color:white">
            <p><span>後日</span></p>
          </div>
        </div>
        ...
        <div id="u77" class="ax_default label" data-label="Tomorrow">
          ...
          <div id="u77_text" class="text " onclick="window.location='/footballui/public/page_a5d2';">
            <p><span>明日</span></p>
          </div>
        </div>
        ...
        <div id="u78" class="ax_default label" data-label="Today">
          ...
          <div id="u78_text" class="text " onclick="window.location='/footballui/public/page_a5';">
            <p><span>今日</span></p>
          </div>
        </div>
      ...
      <!--Chart1-->
      @foreach($b5s as $datum)



      

      <div id="chart{{ $datum->game_id }}" class="chart1">    
      <script>
 



        let chart{{ $datum->game_id }} = new CanvasJS.Chart("chart{{ $datum->game_id }}", {
        //animationEnabled: false,
        //theme: "dark2",
        title:{
          text: "{{ $datum->host }} vs {{ $datum->guest }}"
        },
        toolTip:{
          enabled: false,
          shared:false
        ...
        data: [{
          ...
          color: "red",
          dataPoints: [
          { x: 5, y: {{ $datum->h1 }}, label:"1" },
          { x: 10, y: {{ $datum->h2 }}, label:"2" },
          { x: 15, y: {{ $datum->h3 }}, label:"3" },
          { x: 20, y: {{ $datum->h4 }}, label:"4" },
          { x: 25, y: {{ $datum->h5 }}, label:"5" },
          { x: 30, y: {{ $datum->h6 }}, label:"6" },
          { x: 35, y: {{ $datum->h7 }}, label:"7" },
          { x: 40, y: {{ $datum->h8 }}, label:"8" },
          { x: 45, y: {{ $datum->h9 }}, label:"9" },
          { x: 50, y: {{ $datum->h10 }}, label:"10" },
          { x: 55, y: {{ $datum->h11 }}, label:"11" },
          { x: 60, y: {{ $datum->h12 }}, label:"12" },
          { x: 65, y: {{ $datum->h13 }}, label:"13" },
          { x: 70, y: {{ $datum->h14 }}, label:"14" },
          { x: 75, y: {{ $datum->h15 }}, label:"15" },
          { x: 80, y: {{ $datum->h16 }}, label:"16" },
          { x: 85, y: {{ $datum->h17 }}, label:"17" },
          { x: 90, y: {{ $datum->h18 }}, label:"18" },
          { x: 95, y: {{ $datum->h19 }}, label:"19" },
          { x: 100, y: {{ $datum->h20 }}, label:"20" }
        ...
        },
        {
          ...
          color: "green",
          dataPoints: [
          { x: 5, y: {{ $datum->g1 }}, label:"1" },
          { x: 10, y: {{ $datum->g2 }}, label:"2" },
          { x: 15, y: {{ $datum->g3 }}, label:"3" },
          { x: 20, y: {{ $datum->g4 }}, label:"4" },
          { x: 25, y: {{ $datum->g5 }}, label:"5" },
          { x: 30, y: {{ $datum->g6 }}, label:"6" },
          { x: 35, y: {{ $datum->g7 }}, label:"7" },
          { x: 40, y: {{ $datum->g8 }}, label:"8" },
          { x: 45, y: {{ $datum->g9 }}, label:"9" },
          { x: 50, y: {{ $datum->g10 }}, label:"10" },
          { x: 55, y: {{ $datum->g11 }}, label:"11" },
          { x: 60, y: {{ $datum->g12 }}, label:"12" },
          { x: 65, y: {{ $datum->g13 }}, label:"13" },
          { x: 70, y: {{ $datum->g14 }}, label:"14" },
          { x: 75, y: {{ $datum->g15 }}, label:"15" },
          { x: 80, y: {{ $datum->g16 }}, label:"16" },
          { x: 85, y: {{ $datum->g17 }}, label:"17" },
          { x: 90, y: {{ $datum->g18 }}, label:"18" },
          { x: 95, y: {{ $datum->g19 }}, label:"19" },
          { x: 100, y: {{ $datum->g20 }}, label:"20" }
...

        {
          ...
          color: "blue",
          dataPoints: [
          { x: 5, y: {{ $datum->t1 }}, label:"1" },
          { x: 10, y: {{ $datum->t2 }}, label:"2" },
          { x: 15, y: {{ $datum->t3 }}, label:"3" },
          { x: 20, y: {{ $datum->t4 }}, label:"4" },
          { x: 25, y: {{ $datum->t5 }}, label:"5" },
          { x: 30, y: {{ $datum->t6 }}, label:"6" },
          { x: 35, y: {{ $datum->t7 }}, label:"7" },
          { x: 40, y: {{ $datum->t8 }}, label:"8" },
          { x: 45, y: {{ $datum->t9 }}, label:"9" },
          { x: 50, y: {{ $datum->t10 }}, label:"10" },
          { x: 55, y: {{ $datum->t11 }}, label:"11" },
          { x: 60, y: {{ $datum->t12 }}, label:"12" },
          { x: 65, y: {{ $datum->t13 }}, label:"13" },
          { x: 70, y: {{ $datum->t14 }}, label:"14" },
          { x: 75, y: {{ $datum->t15 }}, label:"15" },
          { x: 80, y: {{ $datum->t16 }}, label:"16" },
          { x: 85, y: {{ $datum->t17 }}, label:"17" },
          { x: 90, y: {{ $datum->t18 }}, label:"18" },
          { x: 95, y: {{ $datum->t19 }}, label:"19" },
          { x: 100, y: {{ $datum->t20 }}, label:"20" }
      ...
      {{ $b5s->links('vendor.pagination.semantic-ui') }}
